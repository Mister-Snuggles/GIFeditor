...
public class ImageEditor extends Application {
    ...
    private static String title = "Simple Image File Editor";
    private static String copyright = "2010 David Alex Lamb (Adapted by 2017 Joey Sun)";
    ...
    /**
     * Editor main program.  Constructs an instance of an ImageEditor and
